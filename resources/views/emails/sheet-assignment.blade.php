...
<head>
    ...
    <title>Assigned on a Sheet</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 24px 24px 20px; background-color: #ffffff; border-bottom: 1px solid #e5e7eb;">
                            <h2 style="margin: 0; font-size: 18px; font-weight: 600; color: #111827; line-height: 1.3;">
                                You were assigned on a Sheet
                            </h2>
                            <p style="margin: 6px 0 0; font-size: 13px; color: #6b7280;">
                                {{ $assignedBy->name }} set you as "{{ $columnName }}" on the sheet "{{ $sheet->name }}".
                            </p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="text-align: center; padding: 0 16px;">
                            <p style="margin: 0; font-size: 12px; color: #9ca3af; line-height: 1.5;">
                                This email was sent because you were assigned as a person on this sheet.
                            </p>
                        </td>
                    </tr>
                </table>
