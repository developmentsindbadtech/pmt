...
<head>
    ...
    <title>You were mentioned on a Sheet</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 24px 24px 20px; background-color: #ffffff; border-bottom: 1px solid #e5e7eb;">
                            ...
                            <p style="margin: 6px 0 0; font-size: 13px; color: #6b7280;">
                                {{ $mentionedBy->name }} mentioned you on the sheet "{{ $sheet->name }}"
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 20px 24px;">
                            <div style="margin-bottom: 16px;">
                                <span style="display: inline-block; font-size: 11px; font-weight: 600; color: #6b7280; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 6px;">Item</span>
                    ...
                    <tr>
                        <td style="text-align: center; padding: 0 16px;">
                            <p style="margin: 0; font-size: 12px; color: #9ca3af; line-height: 1.5;">
                                This email was sent because you were mentioned in a sheet comment.
                            </p>
                        </td>
                    </tr>
                </table>
