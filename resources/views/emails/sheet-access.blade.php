                    ...
                    <tr>
                        <td style="padding: 24px 24px 20px; background-color: #ffffff; border-bottom: 1px solid #e5e7eb;">
                            <h2 style="margin: 0; font-size: 18px; font-weight: 600; color: #111827; line-height: 1.3;">
                                You were given access to a Sheet
                            </h2>
                            <p style="margin: 6px 0 0; font-size: 13px; color: #6b7280;">
                                {{ $grantedBy->name }} added you to "{{ $sheet->name }}".
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 20px 24px;">
                            <span style="display: inline-block; font-size: 11px; font-weight: 600; color: #6b7280; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 6px;">Sheet</span>
                            <h2 style="margin: 0; font-size: 16px; font-weight: 600; color: #111827; line-height: 1.4;">
                                {{ $sheet->name }}
                            </h2>
                            @if($sheet->description)
                                <p style="margin: 8px 0 0; font-size: 14px; color: #374151;">{{ mb_substr($sheet->description, 0, 200) }}{{ mb_strlen($sheet->description) > 200 ? '…' : '' }}</p>
                            @endif
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="text-align: center; padding: 0 16px;">
                            <p style="margin: 0; font-size: 12px; color: #9ca3af; line-height: 1.5;">
                                This email was sent because you were granted access to this sheet.
                            </p>
                        </td>
                    </tr>
                </table>
