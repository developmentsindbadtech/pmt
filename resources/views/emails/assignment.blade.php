                    ...
                    <tr>
                        <td style="padding: 24px 24px 20px; background-color: #ffffff; border-bottom: 1px solid #e5e7eb;">
                            ...
                            <p style="margin: 6px 0 0; font-size: 13px; color: #6b7280;">
                                {{ $assignedBy->name }} assigned you to {{ $item->isBug() ? 'Bug' : 'Task' }} #{{ $item->number }}
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 20px 24px;">
                            ...
                            <div style="padding-top: 16px; border-top: 1px solid #e5e7eb;">
                                ...
                                <p style="margin: 0; font-size: 14px; color: #374151; line-height: 1.6; white-space: pre-wrap;">{{ mb_substr(strip_tags($item->description), 0, 300) }}{{ mb_strlen($item->description) > 300 ? '...' : '' }}</p>
                            </div>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="text-align: center; padding: 0 16px;">
                            <p style="margin: 0; font-size: 12px; color: #9ca3af; line-height: 1.5;">
                                This email was sent because you were assigned to this {{ $item->isBug() ? 'bug' : 'task' }}.
                            </p>
                        </td>
                    </tr>
                </table>
